import 'package:dart_project/pratica/funcionario.dart';

class A {
  final String a;
  final String b;
  final Function f;
  A({required this.a, required this.b, required this.f});
}
...
class B {
  ...
  final Function f;
  final String c;
  B({required this.a, required this.b, required this.c, required this.f});
}
